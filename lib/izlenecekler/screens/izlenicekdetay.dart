...
class TodoDetailState extends State {
  ...
  Widget build(BuildContext context) {
    ...
    var title = todo.title == "" ? " Dizi&Film " : todo.title;
    return Scaffold(
        appBar: AppBar(
  ...
  void delete() async {
    ...
    if (result != 0) {
      AlertDialog alertDialog = AlertDialog(
        title: Text(" Dizi&Film Sil"),
        content: Text(" Dizi&Film Silindi"),
      );
  ...
  void showAlert(bool isUpdate) {
    ...
    if (isUpdate) {
      alertDialog = AlertDialog(
        title: Text(" Dizi&Film Güncelle "),
        content: Text(" Dizi&Film Güncellendi "),
      );
    } else {
      alertDialog = AlertDialog(
        title: Text(" Dizi&Film Ekle "),
        content: Text(" Dizi&Film Eklendi "),
      );
    }
    showDialog(context: context, builder: (_) => alertDialog);
  }
